...
main ()
{
  ...
  while ((e = xcb_wait_for_event (c))) {
    ...
    case XCB_EXPOSE: {
      ...
      xcb_poly_fill_rectangle (c, win, foreground, 2, rectangles);

      xcb_fill_poly(c, win, foreground, XCB_POLY_SHAPE_CONVEX, XCB_COORD_MODE_ORIGIN, 3, tri_points);
